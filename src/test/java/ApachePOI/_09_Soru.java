...
//        1 x 10 = 10
        ...
        for (int i = 1; i <= 10; i++) {
            for (int j = 1; j <= 10; j++) {
                ...
                Cell cell1 = yeniSatir.createCell(0);
                cell1.setCellValue(i);
                Cell cell2 = yeniSatir.createCell(1);
                cell2.setCellValue("x");
                Cell cell3 = yeniSatir.createCell(2);
                cell3.setCellValue(j);
                Cell cell4 = yeniSatir.createCell(3);
                cell4.setCellValue("=");
                Cell cell5 = yeniSatir.createCell(4);
